              ...
              <table class="table table-hover text-center table-bordered">
                ...
                <tbody>
                  <tr v-for="(item, index) in all?.data" :key="item.id" :class="`table_rows table_row_${item.id}`">
                    ...
                    <td class="text-limit">{{ index + 1 }}</td>
                    <td class="text-limit">{{ item.remarks }}</td>
                    <td class="text-limit">{{ item.loss_category_id?.title }}</td>
                    <td class="text-limit">{{ item.loss_date }}</td>
                    <td class="text-limit">{{ item.start_time }}</td>
                    <td class="text-limit">{{ item.end_time }}</td>
                    <td>
                      {{
                        (() => {
