            ...
            <div class="col-12 col-md-6 mb-2 mb-md-0">
              <div class="d-flex">
                ...
                >
                  ...
                  <option :value="value.id" v-for="value in projects">
                    {{ value.name }}
                  </option>
                </select>
              </div>
  ...
  methods: {
    ...
    get_all_projects: async function () {
      ...
      if (response && response.data) {
        ...
        this.first_project = this.projects[0] || null;
      }
    },
    ...
    setProjectId: function (event) {
      this.set_project_id(event.target.value);
      this.get_all(event.target.value);
    },
  },
  computed: {
