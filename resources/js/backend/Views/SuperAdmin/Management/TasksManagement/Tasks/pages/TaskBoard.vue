<template>
  ...
  >
      ...
      <div class="toolbar-left">
        ...
        <div class="file-info">
          <h2 class="sheet-title">
            ...
            <span v-else class="all-filter-badge">
              - All Projects
            </span>
          </h2>
    ...
    <div class="table-container p-2">
      ...
      <div class="professional-user-tabs mb-3">
...
export default {
  ...
  methods: {
    ...
    filterProjectsByUser(user) {
      ...
      console.log(`Filtered ${userProjects.length} projects for user ${user.name}:`, userProjects.map(p => p.name));
    },
