...
export default {
    ...
    mounted() {
        ...
        window.addEventListener('collapse-all-menus-employee', this.handleCollapseAll);
    },
    beforeDestroy() {
        window.removeEventListener('collapse-all-menus-employee', this.handleCollapseAll);
    },
    methods: {
        toggleMenu() {
            if (!this.is_show) {
