...
namespace App\Modules\Management\SystemLossManagement\SystemLossCategory\Models;
...
{
    use SoftDeletes;
    protected $table = "system_loss_categories";
    protected $guarded = [];


    public static $userModel = \App\Modules\Management\UserManagement\User\Models\Model::class;

    // public static $monthlyMealRatesModel = \App\Modules\Management\SystemLossManagement\SystemLossCategoryGroup\Models\Model::class;
