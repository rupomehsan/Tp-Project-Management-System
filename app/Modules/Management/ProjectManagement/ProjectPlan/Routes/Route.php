...
use App\Modules\Management\ProjectManagement\ProjectPlan\Controller\Controller;
use Illuminate\Support\Facades\Route;

Route::prefix('v1')->group(function () {
    Route::prefix('project-plans')->group(function () {
        ...
        Route::post('project-module-management/delete/{slug}', [Controller::class, 'destroy']);
